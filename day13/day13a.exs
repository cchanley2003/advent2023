...
defmodule Day13 do
  ...
  def check_for_reflection(list, potential_boundary) do
    check_for_reflection(list, potential_boundary, 1)
  end

  def check_for_reflection(list, potential_boundary, step) do
    v = Vec.new(list)
    ...
    if left < 0 or right > vec_size(v) - 1 do
      ...
      # dbg(v[left])
      # dbg(v[right])
      if v[left] == v[right] do
        check_for_reflection(list, potential_boundary, step + 1)
      else
        false
      end
    end
